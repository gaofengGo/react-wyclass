...
router.get('/slider', (ctx) => {
    ...
    {
        id:4,
        picUrl:"http://y.gtimg.cn/music/common/upload/MUSIC_FOCUS/313910.jpg"
     },]
    ctx.body = slider
})
router.get('/sliders', (ctx) => {
    const sliders = [
        {
            id:5,
            picUrl:"http://y.gtimg.cn/music/common/upload/MUSIC_FOCUS/313835.jpg"
        },
        {
            id:6,
            picUrl:"http://y.gtimg.cn/music/common/upload/MUSIC_FOCUS/313965.jpg"
        },
        {
            id:7,
            picUrl:"http://y.gtimg.cn/music/common/upload/MUSIC_FOCUS/313712.jpg"
        },
        {
            id:8,
            picUrl:"http://y.gtimg.cn/music/common/upload/MUSIC_FOCUS/313151.jpg"
        },
    ]
    ctx.body = sliders
})
